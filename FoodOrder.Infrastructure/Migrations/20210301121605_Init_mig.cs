        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Telephone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    Rate = table.Column<int>(type: "int", nullable: false),
                    AverageDeliverTime = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comment_Restuarant_RestuarantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumUse = table.Column<int>(type: "int", nullable: false),
                    RestuarantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coupon_Restuarant_RestuarantId",
                        column: x => x.RestuarantId,
                        principalTable: "Restuarant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FoodTypeName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ResurarantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menu_Restuarant_ResurarantId",
                        column: x => x.ResurarantId,
                        principalTable: "Restuarant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToMinute = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpeningHours_Restuarant_RestuarantId",
                        column: x => x.RestuarantId,
                        principalTable: "Restuarant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRestuarantFavorite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRestuarantFavorite_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserRestuarantFavorite_Restuarant_RestuarantId",
                        column: x => x.RestuarantId,
                        principalTable: "Restuarant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coupon_RestuarantId",
                table: "Coupon",
                column: "RestuarantId");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_ResurarantId",
                table: "Menu",
                column: "ResurarantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpeningHours_RestuarantId",
                table: "OpeningHours",
                column: "RestuarantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRestuarantFavorite_RestuarantId",
                table: "UserRestuarantFavorite",
                column: "RestuarantId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRestuarantFavorite_UserId",
                table: "UserRestuarantFavorite",
                column: "UserId");
        }
